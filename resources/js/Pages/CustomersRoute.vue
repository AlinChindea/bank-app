      ...
      <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              <h1 class="text-xl md:text-2xl font-semibold leading-tight tracking-tight text-emerald-400 lg:text-4xl dark:text-emerald-400">Register a customer</h1>
              <form @submit.prevent="createCustomer" class="space-y-4 md:space-y-6">
                <div class="mb-5">
                  <label for="name" class="block mb-2 text-sm md:text-lg font-medium text-gray-950 dark:text-white">Customer name</label>
                ...
                <div class="mb-5">
                  <label for="ssn" class="block mb-2 text-sm md:text-lg font-medium text-gray-950 dark:text-white">Customer's social security number</label>
                ...
                <button type="submit" class="text-white bg-rose-400 hover:bg-rose-600 focus:ring-4 focus:outline-none focus:ring-rose-300 font-bold rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-rose-400 dark:hover:bg-rose-600 dark:focus:ring-rose-700">Submit</button>
              </form>
            </div>
        </div>
      </div>
