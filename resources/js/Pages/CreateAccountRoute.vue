<template>
    <section>
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            <h1 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Add a new account</h1>
            <form @submit.prevent="createAccount">
                ...
                <button type="submit" class="inline-flex items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-rose-400 rounded-lg focus:ring-4 focus:ring-rose-300 dark:bg-rose-400 dark:hover:bg-rose-600 dark:focus:ring-rose-700 hover:bg-rose-600">
                    Add product
                </button>
            </form>
        </div>
